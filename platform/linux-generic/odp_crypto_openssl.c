...
static int openssl_capability(odp_crypto_capability_t *capa)
{
...
static int openssl_cipher_capability(odp_cipher_alg_t cipher,
...
static int openssl_auth_capability(odp_auth_alg_t auth,
...
static int
openssl_session_create(const odp_crypto_session_param_t *param,
...
static int openssl_session_destroy(odp_crypto_session_t session)
{
...
static int openssl_init_global(void)
{
	size_t mem_size;
	odp_shm_t shm;
	int idx;
...
static int openssl_term_global(void)
{
	int rc = 0;
	int ret;
	int count = 0;
...
static int openssl_init_local(void)
{
	unsigned i;
	int id;
...
static int openssl_term_local(void)
{
	unsigned i;
...
static void openssl_session_print(odp_crypto_session_t hdl)
{
	odp_crypto_generic_session_t *session;
...
static int openssl_op(const odp_packet_t pkt_in[],
		      odp_packet_t pkt_out[],
		      const odp_crypto_packet_op_param_t param[],
		      int num_pkt)
{
...
static int openssl_op_enq(const odp_packet_t pkt_in[],
...
const crypto_fn_t _odp_crypto_openssl_fn = {
	.name = "openssl",
	.init_global = openssl_init_global,
	.term_global = openssl_term_global,
	.init_local = openssl_init_local,
	.term_local = openssl_term_local,
	.capability = openssl_capability,
	.cipher_capability = openssl_cipher_capability,
	.auth_capability = openssl_auth_capability,
	.session_create = openssl_session_create,
	.session_destroy = openssl_session_destroy,
	.session_print = openssl_session_print,
	.op = openssl_op,
	.op_enq = openssl_op_enq,
};

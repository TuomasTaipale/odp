...
static void work_forward_(const char *queue, const work_stats_t *stats)
{
	printf("\n%s:\n"
	       "  work:             %s\n"
...
WORK_AUTOREGISTER(WORK_FORWARD, work_forward_init, work_forward_, work_forward_destroy)
